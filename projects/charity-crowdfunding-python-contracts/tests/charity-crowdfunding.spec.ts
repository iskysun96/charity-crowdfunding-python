...
import { CharityCrowdfundingClient } from '../smart_contracts/artifacts/charity_crowdfunding/client'
import { Account, Algodv2, Indexer } from 'algosdk'
import * as algokit from '@algorandfoundation/algokit-utils'

describe('charity crowdfunding contract', () => {
  ...
  const deploy = async (account: Account, algod: Algodv2, indexer: Indexer) => {
    const client = new CharityCrowdfundingClient(
      {
